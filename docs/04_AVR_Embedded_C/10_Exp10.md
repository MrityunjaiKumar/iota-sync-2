...
[http://sincgrid.in/avr-tutorials/avr-tutorial-experiment-10/](http://sincgrid.in/avr-tutorials/avr-tutorial-experiment-10/)

```cpp title="http://sincgrid.in/avr-tutorials/avr-tutorial-experiment-10/"
#include <avr/io.h>
